package com.wifi_manager.wifi_analyzer.analyze_network_connection.qr.view;
...
public final class QrCodeFinderView extends RelativeLayout {
    ...
    private void init(Context context) {
        ...
        mFrameRect.left = (QRUtils.getScreenWidth(context) - layoutParams.width) / 2;
    ...
    private void drawText(Canvas canvas, Rect rect) {
        ...
        float left = (QRUtils.getScreenWidth(mContext) - (mPaint.getTextSize()) * text.length()) / 2;
        /*
